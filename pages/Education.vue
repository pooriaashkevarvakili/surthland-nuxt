<template>
  <div class="
    ...
    <div class="">
      <app-tabs class="2xl:w-11/12 xl:w-11/12 lg:w-11/12  5xl:w-full xs:w-full lg:w-full md:w-full mb-16"
        :tabList="tabList">
        <template v-slot:tabPanel-1>
          ...
          <div v-for="item in education" :key="item.id" class="flex justify-between">
            <div>
              {{ item.name }}
            </div>
                  ...
                  <div class="modal-box relative">
                    ...
                    <form @submit.prevent="addEducation">
                      <div class="flex ml-12 flex-col">
                        ...
                        <input type="number" placeholder="number" class="border input border-gray-300 mt-3 w-80 py-4" />
                      </div>
